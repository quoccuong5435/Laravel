                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{ route('guest.register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="fullname_guest" name="fullname_guest" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="emailaddress">Email address</label>
                                        <input class="form-control" type="email" id="email_guest" name="email_guest" required placeholder="Enter your email">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input class="form-control" type="password" required id="password_guest"  name="password_guest" placeholder="Enter your password">
                                    </div>
                                   {{--  <div class="form-group">
